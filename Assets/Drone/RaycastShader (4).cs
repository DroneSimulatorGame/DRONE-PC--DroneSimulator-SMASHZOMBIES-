...
//        attachedRigidbody.velocity = throwVelocity;
...
//        attachedRigidbody.velocity = Vector3.Lerp(
...
public class RaycastShader : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (isHolding && Input.GetKeyDown(KeyCode.V))
        {
            ThrowObject();
        }
