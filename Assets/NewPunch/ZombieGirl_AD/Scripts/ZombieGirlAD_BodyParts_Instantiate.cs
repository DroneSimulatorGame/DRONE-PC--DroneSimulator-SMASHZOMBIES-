...
public class ZombieGirlAD_BodyParts_Instantiate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pref.gameObject.GetComponent<ZombieGirlAD_BodyParts_Customization>().charCustomize(bodyTyp, tshirtTyp, lowerbodyTyp, hairTyp, eyesTyp, dHair);
