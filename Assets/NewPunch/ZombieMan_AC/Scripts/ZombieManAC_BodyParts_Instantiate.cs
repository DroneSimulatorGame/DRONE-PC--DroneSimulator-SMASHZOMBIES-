...
public class ZombieManAC_BodyParts_Instantiate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pref.gameObject.GetComponent<ZombieManAC_BodyParts_Customization>().charCustomize(bodySkn, shirtSkn, trousersSkn, eyesTyp);
    }
