...
public class ZombieGirl_AE_Instantiate : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pref.gameObject.GetComponent<ZombieGirl_AE_Customization>().charCustomize(bodyTyp, sweaterTyp, lowerbodyTyp, hairTyp, eyesTyp, dHair);
